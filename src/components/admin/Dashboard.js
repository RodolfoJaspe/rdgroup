...
} from "../../actions/firstSliderActions";
  ...
  return (
    <div className="dashboard">
      <div className="category1">
        ...
        <AdminImages
          images={firstSlider}
          addImage={addFirstSlider}
          user_id={user_id}
          deleteImage={deleteFirstSlider}
      ...
      <div className="category3">
        <h2>Construction</h2>
        <AdminImages
          images={constructionPics}
          addImage={addConstruction}
          user_id={user_id}
          deleteImage={deleteConstruction}
